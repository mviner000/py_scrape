...
def scrape_book_images(book_data):
    ...
    for data in book_data:
                ...
                try:
                    ...
                    if image_data:
                        ...
                        with open(image_path, "wb") as img_file:
                            ...
                            # Log the successfully processed controlno
        ...
        # Checkpoint: Log the last successfully processed controlno
...
def log_last_processed_controlno(last_controlno):
    # Log the last successfully processed controlno to a checkpoint file
